...
extern inline void list_add(list *l, list_node *new_node);
extern inline int list_empty(const list *l);
extern inline void list_insert(list_node* node, list_node *new_node);
extern inline void _list_add(list_node *prev_node, list_node *next_node, list_node *new_node);
