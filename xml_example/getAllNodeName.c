/*
 * http://blog.csdn.net/tracyjk/article/details/6002435
 * http://blog.sina.com.cn/s/blog_6a1837e90100ns9j.html
 * (xmlNodePtr struct analysis)http://www.oschina.net/question/565065_67992
 */
#include <stdio.h>
#include <assert.h>
#include <string.h>
...
// 			parse_phone(doc, cur);
// 		}
        if(strstr((const char*)cur->name, "text") != NULL) {
            cur = cur->next;
            continue;
        }
        printf("name = %s\n", (char *)cur->name);
